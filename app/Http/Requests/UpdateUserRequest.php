...
class UpdateUserRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'phone.unique' => __('validation.unique', ['attribute' => __('personal-account.personal-data.telephone')]),
            'phone.regex' => __('validation.phone.regex'),
            'phone.min' => __('validation.min.string', ['attribute' => __('personal-account.personal-data.telephone')]),
            'phone.max' => __('validation.max.string', ['attribute' => __('personal-account.personal-data.telephone')]),
        ];
    }
}
