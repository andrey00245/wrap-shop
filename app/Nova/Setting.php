...
class Setting extends Resource
{
    ...
    /**
     * Слоган (footer): тимчасово не показуємо в Nova — див. fields(), панель «Слоган».
     */
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            // Панель «Слоган» тимчасово прихована (поля slogan_* лишаються в БД). Розкоментуй рядок нижче, щоб повернути.
