  ...
  <div class="wrap">
    ...
    <div class="home-products-list swiper">
        <div class="swiper-wrapper" aria-live="polite">
            ...
            <div class="swiper-slide home-products-item banner product-default"
                 role="group">
                <a href="{{$customBlock->url ?? '#'}}" title="3m color" class="category-products-item product-default product-layout banner product-grid">
                    <img class="vertical" data-src="{{$customBlock->getImage()}}" alt="3m color" title="3m color" src="{{$customBlock->getImage()}}">
                </a>
            </div>
            @endif
        @foreach($customBlock->products as $key => $product)
                <div class="swiper-slide home-products-item product-default" data-ids="{{$product->category->id}}"
                     id="homeLatest{{$key}}"
                     role="group">
