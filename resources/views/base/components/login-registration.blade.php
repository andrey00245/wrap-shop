<div id="login-popup" class="popup-overlay popup-right">
  ...
  <div class="reg_block simple-popup-nav flex-center">
    <a href="#" data-account="login" class="login-show item button active">Вхід</a>
    <a href="#" data-account="registration" class="registration-show reg_form_link item button">Реєстрація</a>
  </div>
  <div class="popup-window active" id="popup-login" style="display: block;">
    <div class="inner form-horizontal">
      ...
      <div id="column-login" class="popup-social">
        <p>Увійти за допомогою соціальної мережі</p>
      ...
      <p>Увійти за допомогою email та пароля</p>
      <div class="popup-form">
        <form id="form-login" class="form" action="#" novalidate="" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group group-password">
            <input class="form-control form-field" type="password" name="password" placeholder="Пароль" id="input-password-popup" autocomplete="current-password" required=""><i class="fal fa-key fa-lg input-icon" aria-hidden="true"></i>
          ...
          <div class="wrap-send">
            <button type="submit" class="colord button send_btn btn-social" data-account="login" id="button-login-popup"><i class="fas fa-chevron-right" aria-hidden="true"></i>Увійти</button>
          </div>
          <div id="account-support-links">
            <a href="#" data-account="forgot_password" class="forgot_password-show forgot_password colord">Забули пароль?</a>
          </div>
        </form>
      </div>

      <div class="reg_block">
        <p>Ви ще не маєте свого профілю? <a href="#" data-account="registration" class="registration-show reg_form_link colord">Реєстрація</a></p>
      </div>
    </div>
  </div>
  <div class="popup-window" id="popup-forgot_password" style="display: none;">
    <div class="inner form-horizontal">
      <p>Забули пароль?</p>
      <p>Введіть адресу своєї електронної пошти і ми надішлемо Вам новий пароль для входу</p>
      <div class="popup-form">
        <form id="form-forgot_password" class="form" action="#" novalidate="" method="post" enctype="multipart/form-data">
          ...
          <div class="wrap-send">
            <button type="submit" class="colord button send_btn btn-social" data-account="forgot_password" id="button-forgot-popup"><i class="fas fa-chevron-right" aria-hidden="true"></i>Відправити</button>
          </div>
        </form>
      </div>
      <div class="reg_block">
        <a href="#" data-account="login" class="login-show forgot_password colord active">Я згадав свій пароль</a>
      </div>
    </div>
  </div>
  <div class="popup-window" id="popup-forgot_password-sucess">
    <div class="inner form-horizontal">
      <p>Пароль відправлено на електронну адресу</p>
      <div class="popup-btn">
        <a href="#" data-account="login" class="colord button login-show btn-social active"><i class="fas fa-chevron-right" aria-hidden="true"></i>Увійти з новим паролем</a>
      </div>
    </div>
  </div>
  <div class="popup-window" id="popup-registration" style="display: none;">
    <div class="inner form-horizontal">
      <p>Реєстрація на сайті</p>
      <div class="popup-form">
        <form id="form-registration" class="form" action="#" novalidate="" method="post" enctype="multipart/form-data">
          <input type="hidden" name="country_code" id="input_country_code">
          <input type="hidden" name="account" id="account_register" class="account_form" value="login">
          <div class="form-group group-firstname" id="regular-field-firstname">
            <input autocomplete="on" type="text" id="input-firstname" name="firstname" value="" maxlength="40" class="form-control form-field required" required="" placeholder="Ім'я">
          </div>
          <div class="form-group group-lastname" id="regular-field-lastname">
            <input autocomplete="on" type="text" id="input-lastname" name="lastname" value="" maxlength="40" class="form-control form-field required" required="" placeholder="Прізвище">
          </div>
          <div class="form-group group-telephone" id="regular-field-telephone">
            <input autocomplete="on" type="tel" id="input-telephone" name="telephone" value="" maxlength="40" class="form-control form-field numeric required" required="" placeholder="Мобільний">
          </div>
          ...
          <div class="form-group group-password" id="regular-field-password">
            <input autocomplete="on" type="password" id="input-password" name="password" value="" maxlength="40" class="form-control form-field required" required="" placeholder="Пароль">
          ...
          <div id="slagreep" class="form-group">
            <div class="checkbox is_checkbox">
              <label id="sagree" for="agree"><input type="checkbox" class="input-checkbox_reg" name="agree" value="" id="agree" checked="checked" style="display: none;">Реєструючись, ви погоджуєтеся з умовами положення про обробку і захист персональних даних та угодою користувача</label>
            </div>
          </div>
          <div class="wrap-send">
            <button type="submit" class="colord button send_btn btn-social" data-account="registration" id="button-register-popup"><i class="fas fa-chevron-right" aria-hidden="true"></i>Реєстрація</button>
          </div>
        </form>
      </div>
      <div id="column-login" class="popup-social">
      ...
      <div class="reg_block">
        <p>Вже реєструвалися? <a href="#" data-account="login" class="login-show colord active">Вхід</a></p>
      </div>
    </div>
  </div>
