...
{{--        </script>--}}
      ...
      <div id="column-login" class="popup-social">
        ...
        <div class="social_block flex-wrap">
          <div class="colord button soc_ico facebook onclick" data-auth="Facebook" rel="noreferrer" data-toggle="tooltip" title="Facebook">
              <a href="{{ route('auth.facebook') }}" class="colord button soc_ico facebook" rel="noreferrer" data-toggle="tooltip" title="Facebook">
            ...
            <a href="{{ route('auth.google') }}" class="colord button soc_ico google" data-auth="Google" rel="noreferrer" data-toggle="tooltip" title="Google">
      ...
      <div class="popup-form">
        <form id="form-login" class="form" action="auth/login" novalidate="" method="post" enctype="multipart/form-data">
  ...
  <div class="popup-window" id="popup-registration" style="display: none;">
    <div class="inner form-horizontal">
      ...
      <div class="popup-form">
        <form id="form-registration" class="form" action="auth/register" novalidate="" method="post" enctype="multipart/form-data">
          <input type="hidden" name="country_code" id="input_country_code">
          <input type="hidden" name="account" id="account_register" class="account_form" value="login">
          <div class="form-group group-firstname" id="regular-field-firstname">
            <input autocomplete="on" type="text" id="input-name" name="name" value="" maxlength="40" class="form-control form-field required" required="" placeholder="{{__('popup.login_register.firstname')}}">
          </div>
          <div class="form-group group-lastname" id="regular-field-lastname">
            <input autocomplete="on" type="text" id="input-last_name" name="last_name" value="" maxlength="40" class="form-control form-field required" required="" placeholder="{{__('popup.login_register.lastname')}}">
          </div>
