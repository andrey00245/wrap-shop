<ul class="menu">
  ...
  <li class="{{url()->current() === route('news') ? 'active' : ''}}"><a href="{{route('news')}}" title="{{__('header_footer.news')}}">{{__('header_footer.news')}}</a></li>
  ...
  <li><a href="{{route('privacy-policy')}}" title="{{__('header_footer.offers')}}">{{__('header_footer.offers')}}</a></li>
</ul>
