...
@section('account.content')
  ...
  <div class="page-account-home flex-wrap">
    ...
    <a class="item button cart-open" href="#"><i class="fal fa-shopping-cart"></i>{{__('personal-account.account.cart')}} <span class="button account-cart-count">{{$cartItemsCount}}</span></a>
  </div>
@endsection
@push('fixed-catalog')
