...
@section('account.content')
    ...
    <div class="simple-content">
        <div class="simpleedit-nav">
            <div class="button fiz active"><span
                    class="flex-center"></span>{{__('personal-account.personal-data.physical_person')}}</div>
            <div class="button yur"><span
                    class="flex-center"></span>{{__('personal-account.personal-data.legal_entity')}}</div>
        </div>
            ...
            <div class="simpleregister" id="simpleedit">
                    ...
                    <fieldset class="form-horizontal">
                        <div class="form-group required row-edit_email">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" type="email" name="email" id="email"
                                       ...
                                       placeholder="{{__('personal-account.personal-data.enter_email')}}">
                                @error('email')
                        ...
                        <div class="form-group required row-edit_firstname">
                            <label class="control-label col-sm-2"
                                   for="name">{{__('personal-account.personal-data.firstname')}}</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group required row-edit_lastname">
                            <label class="control-label col-sm-2"
                                   for="last_name">{{__('personal-account.personal-data.lastname')}}</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group required row-edit_telephone">
                            <label class="control-label col-sm-2"
                                   for="phone">{{__('personal-account.personal-data.telephone')}}</label>
                            <div class="col-sm-10">
                                <input class="form-control" type="tel" name="phone_account" id="phone_account"
                                       value="{{auth()->user()->phone}}"
                                       placeholder="{{__('personal-account.personal-data.enter_telephone')}}"
                ...
                <div class="simpleregister-button-block buttons flex-justify">
                    <a href="{{route('change-password.edit')}}"
                       title="{{__('personal-account.personal-data.change_password')}}"
                       class="colord link">{{__('personal-account.personal-data.change_password')}}</a>
                    <div class="simpleregister-button-right">
                        <button type="submit" class="button btn-primary button_oc btn"><i
                                class="fas fa-chevron-right"></i><span>{{__('personal-account.personal-data.save_changes')}}</span>
                        </button>
                    </div>
                </div>
            </div>
